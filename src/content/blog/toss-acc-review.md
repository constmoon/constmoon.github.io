...
프리코스 기간이 끝나면 최종 인터뷰를 통해 본코스 합류 여부가 결정된다. 안될 거라는 생각에 마음을 내려놓아서 그랬는지, 막상 멘토(이하 종택님)와의 인터뷰는 카페에서 수다를 떠는 것처럼 편안했다. 인터뷰에서는 코드보다 **일상 속 인지행동과 패턴**에 대한 이야기가 주를 이뤘다. 프리코스가 어땠냐는 질문에 나는 뒤쳐졌던 느낌을 제일 먼저 말했고, 종택님은 내가 프리코스 동안 느낀 불편함이 '나를 드러내지 않는 행동 패턴'에 있다고 짚어줬다. 이를 극복하기 위해 어떤 액션을 취하면 좋을지도 함께 이야기했다.
...
코스 이전의 나는 문제를 마주하면 해결책부터 찾았다. '왜 막히는지'보다 '어떻게 풀지'를 먼저 생각했다. 그러다 보니 같은 자리에서 맴도는 일이 많았다. 병목을 해결한 게 아니라 병목을 피해 간 것이었다.
